...
const Discord = () => {
  useEffect(() => {
    // Redirect to Discord invite after 3 seconds
    const timer = setTimeout(() => {
      window.location.href = "https://discord.com/invite/8k56jfr22u";
    }, 3000);
      ...
      <div className="container mx-auto px-4">
        <Card className="max-w-lg mx-auto p-8 text-center">
          <div className="w-20 h-20 mx-auto mb-6 rounded-full bg-primary/10 flex items-center justify-center">
            <svg className="w-12 h-12 text-primary" viewBox="0 0 71 55" fill="none">
          ...
          <h1 className="text-4xl md:text-5xl font-display font-bold mb-6 text-center animate-fade-in">
                  joining <span className="text-primary animate-text-glow">discord</span>
                </h1>
          <p className="text-muted-foreground mb-8">
            Redirecting you to our Discord community...
          </p>
